    ...
    <>
      <style jsx>{`
        @keyframes gradient-animation {
          0% { background-size: 180% 180%; background-position: 0% 0%; }
          50% { background-size: 240% 240%; background-position: 100% 100%; }
          100% { background-size: 180% 180%; background-position: 0% 0%; }
        }
        .animated-background {
      ...
      `}</style>
      <div
        className="min-h-screen flex flex-col relative overflow-hidden bg-white animated-background"
        style={{
          background: 'radial-gradient(circle at 30% 40%, rgba(182, 214, 255, 0.7) 0%, transparent 50%), radial-gradient(circle at 70% 60%, rgba(255, 255, 255, 0.7) 0%, transparent 50%), white',
